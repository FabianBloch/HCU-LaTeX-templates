...
\lfoot{Nachname1, Nachname2, Nachname3} % hier Nachnamen eintragen
\cfoot{}
\rfoot{\thepage}
...
\newcommand{\Gruppenname}{Gruppenname}
\newcommand{\Namen}{Vor- Nachname (xxxxxxx)\\Vor- Nachname (xxxxxxx)\\Vor- Nachname (xxxxxxx)} % Namen mit Matrikelnummer
\newcommand{\Modul}{Modul lang}
\newcommand{\Studiengang}{M.Sc. Geodäsie und Geoinformatik,\\Geodätische Messtechnik} % B.Sc. Geodäsie und Geoinformatik oder M. Sc. Geodäsie und Geoinformatik,\\Spezialisierung
\newcommand{\Art}{Vorlage Einzelarbeit}
\newcommand{\Titel}{\LaTeX-Vorlage}
\newcommand{\Veranstaltung}{Veranstaltung} % oder \Modul
\newcommand{\Semester}{SoSe 2024} % SoSe 202x oder WiSe 202x/2x
...
\newcommand{\Abgabe}{TT.MM.2024}
\newcommand{\modul}{Modul kurz} % für Kopfzeile
\newcommand{\Kurztitel}{\LaTeX} % für Kopfzeile
